...
// Divide and Conquer
/*
   2. Implement algorithm for Tiling Problem:
        Given an n by n board where n is of the form 2^k where k>=1 (Basically n is a power of 2 with minimum value as 2).
      The board has one missing cell (of size 1*1). Fill the board using L shaped tiles. An L shaped tile is a 2*2 square
      with one cell of size 1*1 missing.
*/
// (Missing 1*1 cell in board)
